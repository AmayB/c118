...
emo_code_url = {
    "empty": [0, "./assets/emoticons/Empty.png"],
    "sadness": [1, "./assets/emoticons/Sadness.png"],
    "enthusiasm": [2, "./assets/emoticons/Enthusiastic.png"],
    "neutral": [3, "./assets/emoticons/Neutral.png"],
    "worry": [4, "./assets/emoticons/Worry.png"],
    "surprise": [5, "./assets/emoticons/Surprise.png"],
    "love": [6, "./assets/emoticons/Love.png"],
    "fun": [7, "./assets/emoticons/Fun.png"],
    "hate": [8, "./assets/emoticons/Hate.png"],
    "happiness": [9, "./assets/emoticons/Happiness.png"],
    "boredom": [10, "./assets/emoticons/Boredom.png"],
    "relief": [11, "./assets/emoticons/Relief.png"],
    "anger": [12, "./assets/emoticons/Anger.png"],
}

train_data = pd.read_csv("./assets/data_files/tweet_emotions.csv")    
training_sentences = []
...
model = load_model("./assets/model_file/Tweets_Text_Emotion.h5")
...
#Display entry
def show_entry():
    day_entry_list = pd.read_csv("./assets/data_files/data_entry.csv")
